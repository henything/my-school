...
Этот документ описывает модель данных первой версии продукта **Азбука движения** для школы **Азбука движения**.
...
Если занятие не отмечено до 22:00:
