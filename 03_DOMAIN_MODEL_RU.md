...
Этот документ описывает предметную модель продукта **Азбука движения** для внутренней системы школы **Азбука движения**.
...
Азбука движения управляет операционной цепочкой детской школы:
...
```text
Если Lesson не имеет заполненной посещаемости до 22:00, система создаёт Task, но не списывает занятия автоматически.
```
...
Когда занятие не отмечено до 22:00.
